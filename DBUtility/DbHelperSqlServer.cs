...
namespace DBUtility
{
    public class DbHelperSqlServer
    {
        ...
        #region 构造函数，根据配置名获取连接字符串 - public DbHelperSqlServer(string paramConfigName)
        /// <summary>
        /// 构造函数，根据配置名获取连接字符串
        /// </summary>
        /// <param name="paramConfigName"></param>
        public DbHelperSqlServer(string paramConfigName)
        {
            ConnectionString = PubConstant.GetConnectionString(paramConfigName);
        }
        #endregion
